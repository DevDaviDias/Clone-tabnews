  ...
  return (
    <div className={`${styles.fundo1} ${darkMode ? styles.dark : ""}`} id="sobre">
      ...
      <p className={styles.subtitulo}>
        ...
        Atualmente curso Análise e Desenvolvimento de Sistemas, buscando evoluir
        diariamente como desenvolvedor front-end, com o objetivo de me tornar full stack.
